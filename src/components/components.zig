...
pub const components = [_]ComponentDef{
    ...
    .{
        ...
        .build_blocks = &[_]BuildBlock{
            .{ .offset = .{ 0, 0, 0 }, .cat = .dust },
            .{ .offset = .{ 1, 1, 0 }, .cat = .dust },
            .{ .offset = .{ 2, 2, 0 }, .cat = .dust },
            .{ .offset = .{ 3, 3, 0 }, .cat = .dust },
            .{ .offset = .{ 0, -1, 0 }, .cat = .block },
            .{ .offset = .{ 1, 0, 0 }, .cat = .block },
            .{ .offset = .{ 2, 1, 0 }, .cat = .block },
            .{ .offset = .{ 3, 2, 0 }, .cat = .block },
        },
    },
    .{
        .name = "staircase_down",
        ...
        .build_blocks = &[_]BuildBlock{
            ...
            .{ .offset = .{ 3, -3, 0 }, .cat = .dust },
            .{ .offset = .{ 0, -1, 0 }, .cat = .block },
            .{ .offset = .{ 1, -2, 0 }, .cat = .block },
            .{ .offset = .{ 2, -3, 0 }, .cat = .block },
            .{ .offset = .{ 3, -4, 0 }, .cat = .block },
        },
    },
};
